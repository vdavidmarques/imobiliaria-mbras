				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-12 col-lg-12">
						...
						<div class="space-footer-1">
							...
							<?
							$compartilhar_link = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
							?>
                    ...
                    ?>" class="footer-tipo1 visible-md visible-lg" target="_blank">
							...
							<div class="follow">
								...
								<a href="https://pt.linkedin.com/company/mbras-solu%C3%A7%C3%B5es-imobili%C3%A1rias" target="_blank">
									<img class="linkdin" src="https://www.mbras.com.br/images/icon-linkedin.png">
								</a>

								<a href="https://www.instagram.com/mbrasempreendimentos/" target="_blank">
									<img class="instagram" src="https://www.mbras.com.br/images/icon-instagram.png">
								</a>

								<a href="https://www.facebook.com/mbrasempreendimentos?fref=ts" target="_blank">
									<img class="face" src="https://www.mbras.com.br/images/icon-facebook.png">
								</a>
...
function cod_utilizacao(variavel, form) {
	...
	url = "https://www.mbras.com.br/model/gravaMenu.php?action="+variavel+"&valor="+form;
	redirecionar  = "https://www.mbras.com.br/imoveis/venda/sp/sao-paulo/"
